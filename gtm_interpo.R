...
points3d(torus300[trs300_vics1, ], col=3)
...
#全ボロノイ領域の頂点への補間
points(trs300_res1[["dirsgs"]][["x1"]][!trs300_res1[["dirsgs"]][["bp1"]]], trs300_res1[["dirsgs"]][["y1"]][!trs300_res1[["dirsgs"]][["bp1"]]], col=2, pch=16, cex=2)
...
points3d(vic1_inter, col=2)

in_torus300<-voronoi_gtm_interpo(figure = torus300, 30)
points3d(in_torus300, col=2)

spheres3d(in_torus300, col=2, radius = 0.08)
rgl.snapshot("torus300_ind.png")

gtm_torus300_colle_set<-torus300_colle_set[[1]]
for (l in 1:5) {
    inter_oricord<-voronoi_gtm_interpo(torus300_colle_set[[1]][[l]][["noizyX"]], 30)
    gtm_torus300_colle_set[[l]][["noizyX"]]<-rbind(torus300_colle_set[[1]][[l]][["noizyX"]], inter_oricord)
    gtm_torus300_colle_set[[l]][["nsample"]]<-nrow(gtm_torus300_colle_set[[l]][["noizyX"]])
    debugText(l, gtm_torus300_colle_set[[l]][["nsample"]])
}


gtm_trs300_w1_5errs<-lapply(gtm_torus300_colle_set[1:5], function(X)torus_disterror(X[["noizyX"]], maxr = 2.5, minr = 1, nps = 300))
par(mgp=c(2.4,1,0))
boxplot(gtm_trs300_w1_5errs, xlab="Data Set", ylab="Error", cex.lab=1.6, cex.axis=1.6, lwd=2)

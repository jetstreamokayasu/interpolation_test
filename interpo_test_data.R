...
plot3d(torus.300[-torus.vic1.line, ], size=5)
aspect3d("iso")
planes3d(torus1.coefs[1], torus1.coefs[2], torus1.coefs[3], torus1.coefs[4], col="blue", alpha=0.7)
points3d(torus.300[torus.vic1.line, ], col=3, size=5)
points3d(torus.vics1.oricord, col=2, size=5)
rgl.snapshot("./data/torus_300_1_plane2.png")
rgl.snapshot("./data/torus_300_1_plane.eps")
